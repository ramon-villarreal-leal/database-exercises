...
VALUES ('Pink Floyd', 'The Dark side Of the Moon', 1977, 'Progressive rock', 21.5),

        ('Micheal Jackson', 'Thriller', 1982, 'Pop/Rock/R&B', 47.3),
        ...
        ('Micheal Jackson', 'Bad', 1987, 'Pop,Funk,Rock', 19.3),
        ...
        ('Celine Dion', 'Lets Talk About Love', 1997, 'Pop/Soft', 19.3),
        ...
        ('Dire Straits', 'Brothers in Arms', 1985, 'Rock/Pop', 19.6),
        ...
        ('Pink Floyd', 'The Wall', 1979, 'Progressive rock', 16.7),
